...
最低位为0的时候表示偶数位置，反之奇数。
第二低位为1的时候表示结束，反之不结束。
https://img-blog.csdn.net/20170217104927023?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvcXFfMzM5MzUyNTQ=/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/Center
MPT树的操作
